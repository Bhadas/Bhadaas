...
export default function EmojiDrawer({ isOpen, onClose }) {
  return (
    <div
      id="drawer-bottom-example"
      className="bottom-0 left-0 right-0 z-40 rounded-t-xl p-4 overflow-y-auto transition-transform  transform-none"
      tabIndex="-1"
