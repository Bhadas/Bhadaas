    ...
    <div class="hidden w-2/12 xl:block bg-white  p-5 overflow-y-auto h-screen  border-4 border-gray-100 rounded-xl shadow-lg">
        <main>
            ...
            <div class="flex flex-col justify-between p-2 bg-gray-100 rounded-lg">
                        <div class="flex flex-row items-center p-4 my-2 bg-red-900 rounded-2xl hover:rounded-2xl cursor-pointer ">
                            <img src="https://www.kormanmd.com/wp-content/uploads/sites/38/2019/02/botox-men-2-768x720.jpg"
                            class="w-10 h-10 rounded-full mr-4" alt=""/>
                            <h2 class="text-sm font-bold">Live khushi</h2>
                        </div> 
                        <div class="flex flex-row  p-4 my-2 bg-red-900 rounded-2xl hover:rounded-2xl cursor-pointer ">
                            <img src="https://www.kormanmd.com/wp-content/uploads/sites/38/2019/02/botox-men-2-768x720.jpg"
                            class="w-10 h-10 rounded-full mr-4" alt=""/>
                            <h2 class="text-sm font-bold">Live Neha</h2>
                        </div> 
                        <div class="flex flex-row  p-4 my-2 bg-red-900 rounded-2xl hover:rounded-2xl cursor-pointer ">
                            <img src="https://www.kormanmd.com/wp-content/uploads/sites/38/2019/02/botox-men-2-768x720.jpg"
                            class="w-10 h-10 rounded-full mr-4" alt=""/>
                            <h2 class="text-sm font-bold">Live Pooja</h2>
                        </div> 
                        </div> 
        </main>
