      ...
      <div class="flex-auto flex flex-col justify-between overflow-y-auto">
        <div class="flex flex-col">
          {/* Left side message start here */}
          {
            ...
            <div class="p-1">
              <div class="px-4 py-3 rounded-full my-2 bg-red-400 text-white items-center">
                <h2 class="text-sm font-semibold text-white">{message?.sender?.username}</h2>
          ...
          <div class="flex flex-row p-2 w-11/12">
            ...
            <div class="w-11/12 p-2">
              <div class="bg-gray-50 p-3 rounded-xl mb-2 relative">
                <h2 class="text-sm font-semibold mb-2 text-red-400">{message?.sender?.username}</h2>
                <p class="text-sm">
                  {message?.content}
                </p>
